...
#'
#'
#' @param transformed_data Final data ready for the website. Must be an R object.
#' @param name name for the file
#'
#'
#' @import here

saveFinalDataFile <- function(transformed_data, name) {

  folder_path <-
    here::here("analysis", "data", "final")
