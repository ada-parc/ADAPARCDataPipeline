#' downloadACSPlace
#'
#' Downloads and Formats ACS Data for the place geography
#'
...
downloadACSPlace <- function(tables, geography = "place", year, survey = "acs5") {
  # TODO: Understand why this function is meaningfully different to the data download flow from what was written for the national data -- can it be combined?
